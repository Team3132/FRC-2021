...
public interface Gamepad extends InputDevice {
    ...
    public abstract Switch getBack();
    ...
    public static Gamepad create(String name, IntToDoubleFunction axisToValue,
            ...
            BooleanSupplier leftStick,
            BooleanSupplier rightStick) {
        return new Gamepad() {
            @Override
