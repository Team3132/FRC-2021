...
public abstract interface Drivebase
    ...
    public class DriveRoutineParameters {
        private static final Path trajectoryPath =
                Paths.get(System.getProperty("java.io.tmpdir"), "paths");
        ...
        public static DriveRoutineParameters getDriveWaypoints(String filename) throws IOException {
            ...
            Path path = trajectoryPath.resolve(filename);
        ...
        public static Trajectory generateTrajectory(Pose2d start,
                List<Translation2d> interiorWaypoints,
                Pose2d end, boolean forward, boolean relative) {
            Log.info("Drivebase", "Generating trajectory into folder %s", trajectoryPath);
        ...
        public boolean equals(Object obj) {
            ...
            // TODO: Check for an equals operator? Should we make this faster since it'll be called
            // often?
