...
public class Robot extends TimedRobot implements Executable, LogHelper {
    ...
    public void init() {
        ...
        subsystems.createZipChain();
        subsystems.createClimberDeployer();
        subsystems.createColourWheel();
        subsystems.createBuddyClimb();
        ...
        controller = new Controller(subsystems, getFMSColourSupplier(), getAllianceLEDColour());
    ...
    public void disabledInit() {
        ...
        controller.run(Sequences.getEmptySequence());
    ...
    public void teleopInit() {
        ...
        subsystems.setLEDColour(getAllianceLEDColour().get());
    }
    ...
    public void createCameraServers() {
        if (!Config.vision.present) {
            debug("Vision not enabled, not creating a camera server");
            return;
        }
    ...
    private void setupUserInterface() {
        OIImpl oi = new OIImpl(controller, subsystems);
    ...
    private void maybeUpdateSmartDashboard() {
        ...
        SmartDashboard.putString("FMS Colour: ", getFMSColour().toString());
    ...
    /**
     * Determines the desired colour wheel colour from FMS. Single letter R, G, B,
     * or Y indicates colour. If there is no letter or a letter other than those,
     * the colour defaults to unknown. Colours are flipped around so that the sensor
     * on the robot will look for the colour perpendicular to the field sensor.
     * 
